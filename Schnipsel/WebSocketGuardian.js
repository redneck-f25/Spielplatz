...
if ( globalThis?._f8ade94f8c74ef1f8a3c0f28d55a6a3eb24389c0?.prototype?.constructor && WebSocket.prototype instanceof globalThis._f8ade94f8c74ef1f8a3c0f28d55a6a3eb24389c0.prototype.constructor ) {
  globalThis.WebSocket = _f8ade94f8c74ef1f8a3c0f28d55a6a3eb24389c0;
  delete globalThis._f8ade94f8c74ef1f8a3c0f28d55a6a3eb24389c0;
}
...
globalThis.WebSocket = (() => ( class WebSocketGuardian extends WebSocket {
  ...
  #guardedOnRecvMessage( event ) {
    if ( event.constructor !== WebSocketGuardian.#GuardedMessageEvent ) {
      ...
      originalEvent.target.ward.dispatchEvent( event );
    }
    else {
